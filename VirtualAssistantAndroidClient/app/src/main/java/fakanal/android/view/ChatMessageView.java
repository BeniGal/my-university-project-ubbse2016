...
import fakanal.android.drawables.ChatMessageDrawable;
import fakanal.android.drawables.ChatMessageStateDrawable;
import fakanal.android.util.ViewUtil;
...
public class ChatMessageView extends RelativeLayout {
    ...
    private void initialize(AttributeSet attrs, int defStyleAttr) {
        ...
        arrowMargin = a.getDimension(R.styleable.ChatMessageView_cmv_arrowMargin, dip2px(10));
    ...
    private void initContent() {
        ...
        LayoutParams containerRlParams = new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
        LayoutParams arrowParams = new LayoutParams(18, 51);
        ...
        switch (arrowPosition) {
            case LEFT: {
                ...
                containerRlParams.addRule(RelativeLayout.RIGHT_OF, arrowImage.getId());
            }
            break;
            case TOP: {
                arrowRotation = 270;
                arrowParams.setMargins((int) arrowMargin, 0, (int) arrowMargin, 0);
                containerRlParams.addRule(RelativeLayout.BELOW, arrowImage.getId());
            }
            break;
            case BOTTOM: {
                arrowRotation = 90;
            ...
            default: {
                ...
                arrowParams.setMargins(0, (int) arrowMargin, 0, (int) arrowMargin);
                containerRlParams.addRule(RelativeLayout.LEFT_OF, arrowImage.getId());
            }
        }
        ...
        super.addView(containerLayout, containerRlParams);
